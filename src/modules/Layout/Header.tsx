...
export const Header: React.FC<Props> = ({ signOut, isAuthenticated }) => {
  ...
  return (
    <header className={classNames("px-4 py-6 font-catamaran md:px-16 text-lg uppercase flex relative z-10 justify-between items-center")}>
      ...
      <nav className="relative flex items-center">
        ...
        <ul className={classNames("absolute top-full right-0 text-right py-3 md:static md:flex md:py-0", {

...
export const Tooltip: React.FC<Props> = ({ content, children }) => {
  return (
    ...
    >
      {children}
      <div className="tooltip__content absolute bottom-full left-1/2 transform -translate-x-1/2 rounded-medium mb-3 px-3 py-2 border theme-border border-solid bg-white theme-text">
        {content}

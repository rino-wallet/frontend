...
const PrivacyPolicy: React.FC = () => {
  return <section>
    ...
    <section className="mb-6">
      <p className="mb-3">
        This Privacy Policy constitutes a part of RINO Terms and Conditions (the “Terms”). The terms used in this Privacy Policy shall have the same meanings as in the Terms except as otherwise provided herein.
      </p>
      <p className="mb-3">
        This Privacy Policy explains how RINO and RINO Operators collect, use, process, disclose, share, transfer, and protect personal information obtained through RINO and its partners. The terms “we,” “us,” and “our” refer to RINO and RINO Operators. When we ask for certain personal information from users, it is because we are required by applicable laws or government orders to collect such information or it is relevant for our specified purposes. Please refer to the separate Cookies Policy for the exact use of cookies.
      </p>
      <p className="mb-3">
    ...
    <section className="mb-6">
      ...
      <p className="mb-3">
        (b) contact information, e.g., address, phone number and email address, cryptocurrency wallet addresses;
      </p>
      <p className="mb-3">
    ...
    <section className="mb-3">
      ...
      <p className="mb-3">
        We also use third-party service provider(s), to assist us in better understanding the use of our site. Our service provider(s) will place cookies on your computer and will receive information that we select, for example, how visitors navigate around our site, what pages are browsed and general transaction information. Our service provider(s) analyzes this information and provides us with aggregate reports. The information and analysis provided by our service provider(s) will be used to assist us in better understanding our visitors’ interests in our site and how to better serve those interests. The information collected by our service provider(s) may be linked to and combined with information that we collect about you while you are using the platform. Our service provider(s) is/are contractually restricted from using information they receive from our Site other than to assist us. We do not hand any of the data collected from our service providers to third parties.
      </p>
    </section>
    ...
    <section className="mb-6">
      ...
      <p className="mb-3">
        (g) to communicate offers, products, services and information on products and activities; and/or
      </p>
      <p className="mb-3">
    ...
    <section className="mb-6">
      ...
      <p className="mb-3">
        You may be requested to provide us with your personal data, such as KYC documents in specific situations to comply with legal and regulatory requirements or in case of a dispute between you and RINO. In such cases RINO expects you to provide us with such requested information for further processing and actions.
      </p>
      <p className="mb-3">
      ...
      <p className="mb-3">
        Under certain circumstances as required by law or as specifically reminded by us, you have the right to request us to restrict the processing of your personal information; however, you understand that such restriction of the processing may prevent us from providing you with some of the RINO Services.
      </p>
      <p className="mb-3">
        5.5 Right to Object
      </p>
      <p className="mb-3">
        Under certain circumstances as required by law or as specifically reminded by us, you have the right to object to the processing of your personal information; however, you understand that such objection to the processing may prevent us from providing you with some of the RINO’s Services.
      </p>
      <p className="mb-3">
    ...
    <section className="mb-6">
      ...
      <p className="mb-3">
        RINO implements various security measures to ensure that your personal data is stored safely and is not compromised in any way. At the same time, RINO cannot in good faith guarantee that data breach is not possible since no security measure can provide absolute protection. It is advised for Users to take their own safety measures such as 2-Factor Authentication or other measures not provided by RinoWallet. If you suspect that your account information or your personal data has been compromised, you should contact RINO Support as soon as possible.
      </p>
    </section>

  ...
  return (
    <div className="mb-3">
      ...
      <label className="mr-3">
        <input type="radio" checked={value === Button.size.SMALL} onClick={(): void => { onChange(Button.size.SMALL); }} /> Small
      </label>
      <label className="mr-3">
        <input type="radio" checked={value === Button.size.MEDIUM} onClick={(): void => { onChange(Button.size.MEDIUM); }} /> Medium
      </label>
      <label className="mr-3">
        <input type="radio" checked={value === Button.size.BIG} onClick={(): void => { onChange(Button.size.BIG); }} /> Big
      </label>
    </div>
  )
}

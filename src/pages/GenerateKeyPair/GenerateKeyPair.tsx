        ...
        <div className="flex mb-5 m-auto">
          <div className="w-full p-10 m-auto">
            ...
            <ol className="list-disc">
              <li className="ml-8 mb-4 "><p className="mb-4 font-normal">
                This document is the <b>only</b> way to recover your account if you lose or forget your password.
              </p></li>
              <li className="ml-8 mb-4 "><p className="mb-4 font-normal">
            ...
            {
              infoChecked ? (<div className="text-center">
                <p className="mb-4 font-normal">

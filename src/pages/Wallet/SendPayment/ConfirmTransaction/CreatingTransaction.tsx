...
const CreatingTransaction: React.FC<Props> = ({ amount, address, priority, fee, stage }) => (
  <div
    ...
    <div className="m-auto p-5">
      <div className="md:flex md:space-x-6">
        ...
        <div className={"md:w-3/4"}>
          ...
          <div className="text-l font-bold mb-4">Transaction In Progress:</div>
        </div>
      </div>
      ...
      <div className="form-field">
        <Label label="destination address" inline>
          <span
